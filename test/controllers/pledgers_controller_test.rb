...
class PledgersControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create pledger' do
    assert_difference('Pledger.count') do
      post pledgers_url,
           params: { pledger:
            { amount: @pledger.amount, expecteddate: @pledger.expecteddate,
              fullfilled: @pledger.fullfilled,
              name: @pledger.name,
              phonenumber: @pledger.phonenumber } }
    end
  ...
  test 'should update pledger' do
    patch pledger_url(@pledger),
          params: { pledger: { amount: @pledger.amount,
                               expecteddate: @pledger.expecteddate,
                               fullfilled: @pledger.fullfilled,
                               name: @pledger.name,
                               phonenumber: @pledger.phonenumber } }
